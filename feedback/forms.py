...
class MessageForm(ModelForm):
    ...
    phone = CharField(label=False, max_length=100, widget=TextInput(attrs={"class": "bp5-input bp5-fill bp5-large", "data-phone": "", "placeholder": "+7"}))
    text = CharField(label=False, max_length=500, required=False, widget=Textarea(attrs={"class": "bp5-input bp5-fill pio-input", "data-textarea": "", "rows": 4}))
